...
public class Jukebox implements Runnable, ActionListener {
	Song song;
	JButton button=new JButton("strange song");
	JButton button2=new JButton("another strange song");
	public void run() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==button) {
			...
			song = new Song("file_example_MP3_1MG.mp3");
			song.play();
